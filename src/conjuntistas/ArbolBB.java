...
public class ArbolBB {
    ...
    {//Devuelve verdadero si el elemento recibido por parametro esta en el arbol el elemento
        boolean exito=false;
        if(!esVacio())
        {
   ...
   public boolean eliminar(Comparable elem) {
    ...
    private boolean eliminarAux(Comparable elem, NodoABB n, NodoABB padre) {
        boolean exito = false;
    ...
    private boolean eliminarCaso1(NodoABB n, NodoABB padre) {
    ...
    private boolean eliminarCaso2(NodoABB n, NodoABB padre) {
    ...
    private Lista listarAux(NodoABB n, Lista lis) {
        if (n != null) {
